 ...
 */
package pk.reports.ttrschetnaopl;
...
import pk.reports.ttrschetfactura.TTRSchetFacturaDPanel;
 ...
 * @author dev_tt
 */
public class TTRSchetNaOpl implements TTIReport {
        ...
        if (d.getReturnStatus() == ADialog.RET_OK) {
            try {
                ...
                JasperReport jasperReport =
                        ...
                        getClass().getResource("/pk/reports/ttrschetnaopl/TTRSchetNaOpl.jrxml").openStream());
                ...
                map.put("POST_PO_DOVERENOSTI", "Поставка товаров (работ, услуг) осуществлена: "
                        + (p.getPoDoverennostiCheckBox() ? "по доверенности" : "без доверенности"));
