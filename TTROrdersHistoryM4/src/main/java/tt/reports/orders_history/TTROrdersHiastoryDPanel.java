 ...
 * @author  pacman
 */
public class TTROrdersHiastoryDPanel extends javax.swing.JPanel implements IADialogPanel {

    /** Creates new form OrdersHiastoryDPanel */
    public TTROrdersHiastoryDPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tradeterminal.TradeTerminalApp.class).getContext().getResourceMap(TTROrdersHiastoryDPanel.class);
